...
describe('CreationView', function () {
    ...
    describe('Creation', function () {
        ...
        it('should update values on form submit and redirect to edit page', function () {
            $('.create-view .react-admin-field-title input').sendKeys('My new post')
            .then(function () {
                // Fill textarea
                return $('.create-view .react-admin-field-teaser textarea').sendKeys('My teaser');
            })
            .then(function () {
                // Fill wysiwyg
                return $('.create-view .react-admin-field-body .wysiwyg-field').sendKeys('My long text');
            })
            .then(function () {
                return $('.create-view button[type="submit"]').click();
            })
            .then(function () {
    ...
    describe('SelectField', function() {
        ...
        it('should render as a dropdown with reference choices', function () {
            ...
            $('.react-admin-field-post_id span.Select-arrow').click()
            .then(function () {
                browser.driver.wait(function () {
                    return browser.driver.isElementPresent(by.css('.react-admin-field-post_id div.Select-menu-outer'));
                }, 5000); // wait 5s

                return $$('.react-admin-field-post_id .Select-option');
